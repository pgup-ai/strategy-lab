...
| `trend_structure` | runs, SMA40 via fallback (not designed for it) | ✅ canonical: SMA40 break OR N adverse closes | runs with the published span, but replaces the internal exits |
